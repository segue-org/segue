...
class AdminBlueprint(flask.Blueprint):
    def __init__(self):
        ...
        self.add_url_rule('/proposals/<int:proposal_id>/tag/<string:tag_name>', methods=['POST'],   view_func=self.controller.add_tag_to_proposal)
        self.add_url_rule('/proposals/<int:proposal_id>/tag/<string:tag_name>', methods=['DELETE'], view_func=self.controller.remove_tag_from_proposal)
