...
class ProductService(object):
    ...
    def cheapest_for(self, category):
        candidates = Product.query.filter(Product.category == category, self._in_time()).order_by(Product.price)
        if not candidates: return NoSuchProduct()
